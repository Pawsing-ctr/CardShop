...
const ParrotSVG = ({width="44", height="55", color="white"}:IIcon) => {
    return (
        <svg width={width} height={height} viewBox="0 0 400 400" fill={color} xmlns="http://www.w3.org/2000/svg">
        <path d="M191.236 117.086C194.501 96.0678 211.099 44.1669 252.916 72.0365C257.607 75.163 247.848 116.259 249.371 124.101C261.162 184.809 261.162 228.712 216.484 261.748" stroke="#000000" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M258.489 72.1705C309.397 67.8918 292.64 128.684 282.823 135.598C282.77 135.635 285.957 128.684 279.905 121.239C276.179 116.656 261.575 116.656 253.742 118.827" stroke="#000000" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <path d="M233.854 93.5486C233.854 91.6534 233.854 89.7615 233.854 87.8662" stroke="#000000" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    );
};
